	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			blockSecondCombined_nTrials : 1, //Change to 0 if you want 5 blocks (you would probably want to increase blockFirstCombined_nTrials).
			...
			debriefingTextBottom : '<div><p align="center" style="font-size:20px; font-family:arial">' + 'nuova prova ora This result is not a definitive assessment of your attitudes. It is provided for educational purposes only.<br/>' + 
			'Press space to continue. Try to say something smart</p></div>', //Will be shown below the feedback text. 
