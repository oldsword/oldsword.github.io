	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			debriefingTextBottom : '<div>' + 'prova ora This result is not a definitive assessment of your attitudes. It is provided for educational purposes only.<br/>' + 
			'Press space to continue. Try to say something smart</div>', //Will be shown below the feedback text. 
