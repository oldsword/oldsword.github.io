	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			leftKeyText : 'Prema "E" per', 
			rightKeyText : 'Prema "I" per', 
			...
			finalText : 'Prema SPAZIO per continuare', 
			finalTouchText : 'Tocchi la area verde sul fondo per continuare',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Posizioni il dito sinistro sul tasto <b>E</b> e clicchi per elementi della categoria <font color="#0000ff">leftAttribute.</font>' +
				'<br/>Posizioni il dito destro sul tasto <b>I</b> e clicchi per elementi della categoria <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				'Se commette un errore, una <font color="#ff0000"><b>X</b></font> rossa comparirà. ' +
				'Per continuare prema il tasto corretto.<br/>' +
				'<u>Vada più veloce che può</u> ma senza sbagliare!<br/><br/></p>'+
				'<p align="center">Prema <b>SPAZIO</b> quando vuole iniziare.</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Tocchi area verde a <b>sinistra</b> per elementi che appartengono alla categoria <font color="#0000ff">leftAttribute</font>.<br/>',
						'Tocchi area verde a <b>destra</b> per elementi che appartengono alla categoria <font color="#0000ff">rightAttribute</font>.<br/>',
						'Gli elementi appariranno uno alla volta.<br/>',
						'<br/>',
						'Se commette un errore, una <font color="#ff0000"><b>X</b></font> rossa comparirà. Per continuare tocchi il lato coretto. <u>Vada più che veloce che può</u> ma senza sbagliare!',
					'</p>',
					'<p align="center">Tocchi area verde <b>in basso </b> per iniziare.</p>',
				'</div>'
			].join('\n'),
			...
			instCategoriesPractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Parte blockNum di nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Posizioni il dito sinistro sul tasto <b>E</b> e clicchi per elementi della categoria <font color="#336600">leftCategory</font>. ' +
				'<br/>Posizioni il dito destro sul tasto <b>I</b> e clicchi per elementi della categoria <font color="#336600">rightCategory</font>.<br/>' +
			...
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Tocchi area verde a <b>sinistra</b> per elementi che appartengono alla categoria <font color="#336600">leftCategory</font>.<br/>',
						'Tocchi area verde a <b>destra</b> per elementi che appartengono alla categoria <font color="#336600">rightCategory</font>.<br/>',
						'Gli elementi appariranno uno alla volta.<br/>',
						'<br/>',
						'Se commette un errore, una <font color="#ff0000"><b>X</b></font> rossa comparirà. Per continuare tocchi il lato coretto. <u>Vada più che veloce che può</u> ma senza sbagliare!',
					'</p>',
			...
			instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Parte blockNum di nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Usi il tasto <b>E</b> per elementi di <font color="#336600">leftCategory</font> e di <font color="#0000ff">leftAttribute</font>.<br/>' +
				'Usi il taso <b>I</b> per elementi di <font color="#336600">rightCategory</font> e di <font color="#0000ff">rightAttribute</font>.<br/>' +
			...
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'Tocchi area verde a <b>sinistra</b> per elementi di <font color="#336600">leftCategory</font> e di <font color="#0000ff">leftAttribute</font>.</br>',
						'Tocchi area verde a <b>destra</b> per elementi di <font color="#336600">rightCategory</font> e di <font color="#0000ff">rightAttribute</font>.</br>',
							'Se commette un errore, una <font color="#ff0000"><b>X</b></font> rossa comparirà. Per continuare tocchi il lato coretto. <u>Vada più veloce che può</u> ma senza sbagliare!</br>',
						'</p>',
						'<p align="center">Tocchi area verde <b>in basso </b> per iniziare.</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Usi il tasto <b>E</b> per elementi di <font color="#336600">leftCategory</font> e di <font color="#0000ff">leftAttribute</font>.<br/>' +
				'Usi il tasto <b>I</b> per elementi di <font color="#336600">rightCategory</font> e di <font color="#0000ff">rightAttribute</font>.<br/>' +
				'Ogni elemento appartiene ad una sola categoria.<br/><br/>' +
				'<u>Vada più veloce che può</u> ma senza sbagliare!<br/><br/></p>' +
				'<p align="center">Prema <b>SPAZIO</b> quando vuole iniziare.</font></p></div>',
			instSecondCombinedTouch:[
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'Tocchi area verde a <b>destra</b> per elementi di <font color="#336600">rightCategory</font> e di <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
						'<u>Vada più veloce che può</u> ma senza sbagliare!<br/>',
					'</p>',
					'<p align="center">Tocchi area verde <b>in basso </b> per iniziare.</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Usi il tasto <b>E</b> per <font color="#336600">leftCategory</font>.<br/>' +
				'Usi il tasto <b>I</b> per <font color="#336600">rightCategory</font>.<br/><br/>' +
				'<u>Vada più veloce che può</u> ma senza sbagliare!<br/><br/></p>' +
				'<p align="center">Prema <b>SPAZIO</b> quando vuole iniziare.</font></p></div>',
				...
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'Attenzione, le categorie hanno cambiato posizione!<br/>',
							'Tocchi area verde a <b>sinistra</b> per elementi di <font color="#336600">leftCategory</font>.<br/>',
							'Tocchi area verde a <b>destra</b> per elementi di <font color="#336600">rightCategory</font>.<br/>',
							'Gli elementi appariranno uno alla volta.',
							'<br/>',
							'Se commette un errore, una <font color="#ff0000"><b>X</b></font> rossa comparirà. Per continuare tocchi il lato corretto. <u>Vada più veloce che può</u> ma senza sbagliare!<br/>',
						'</p>',
						'<p align="center">Tocchi area verde <b>in basso </b> per iniziare.</p>',
				'</div>'
			].join('\n'),
