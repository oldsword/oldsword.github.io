	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			'Jeśli popełni Pan/i błąd, pojawi się czerwony znak <font color="#ff0000"><b>X</b></font>. ' +
			'Aby kontynuować, należy nacisnąć poprawny przycisk.<p/>',
			...
			leftKeyText : 'Prosimy nacisnąć "E" dla kategorii', 
			rightKeyText : 'Prosimy nacisnąć "I" dla kategorii', 
			...
			finalText : 'Prosimy nacisnąć SPACJĘ, aby kontynuować', 
			finalTouchText : 'Prosimy nacisnąć zielony przycisk na dole, aby kontynuować',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Prosimy umieścić jeden palec lewej ręki na przycisku <b>E</b> i naciskać go dla elementów z kategorii <font color="#0000ff">leftAttribute.</font>' +
				'<br/> Prosimy umieścić jeden palec prawej ręki na przycisku <b>I</b> i naciskać go dla elementów z kategorii <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				'Jeśli popełni Pan/i błąd, pojawi się czerwony znak <font color="#ff0000"><b>X</b></font>.' +
				'Aby kontynuować, należy nacisnąć poprawny przycisk<br/>' +
				'<u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!<br/><br/></p>'+
				'<p align="center">Prosimy nacisnąć <b>SPACJĘ</b>, aby kontynuować.</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Prosimy dotknąć zielonego pola po <b>lewej</b> dla elementów należących do kategorii <font color="#0000ff">leftAttribute</font>.<br/>',
						'Prosimy dotknąć zielonego pola po <b>prawej</b> dla elementów należących do kategorii <font color="#0000ff">rightAttribute</font>.<br/>',
						'Elementy będą się pojawiać pojedynczo.<br/>',
						'<br/>',
						'Jeśli popełni Pan/i błąd, pojawi się czerwony znak <font color="#ff0000"><b>X</b></font>. Aby kontynuować, należy dotknąć prawidłowego pola. <u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!',
					'</p>',
					'<p align="center">Prosimy dotknąć zielonego pola <b>na dole</b>, aby rozpocząć.</p>',
				'</div>'
			].join('\n'),
			...
			instCategoriesPractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Część blockNum z nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Prosimy umieścić jeden palec lewej ręki na przycisku <b>E</b> i naciskać go dla elementów z kategorii  <font color="#336600">leftCategory</font>.' +
				'<br/>Prosimy umieścić jeden palec prawej ręki na przycisku  <b>I</b> i naciskać go dla elementów z kategorii <font color="#336600">rightCategory</font>.<br/>' +
				'Elementy będą się pojawiać pojedynczo.<br/><br/>' +
				'Jeśli popełni Pan/i błąd, pojawi się czerwony znak <font color="#ff0000"><b>X</b></font>.' +
				'Aby kontynuować, należy nacisnąć prawidłowy przycisk.<br/>' +
				'<u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!<br/><br/></p>'+
				'<p align="center">Prosimy nacisnąć <b>SPACJĘ</b>, aby kontynuować.</font></p></div>',
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Prosimy dotknąć zielonego pola po <b>lewej</b> dla elementów należących do kategorii <font color="#336600">leftCategory</font>.<br/>',
						'Prosimy dotknąć zielonego pola po <b>prawej</b> dla elementów należących do kategorii <font color="#336600">rightCategory</font>.<br/>',
						'Elementy będą się pojawiać pojedynczo.<br/>',
						'<br/>',
						'Jeśli popełni Pan/i błąd, pojawi się czerwony znak <font color="#ff0000"><b>X</b></font>. Aby kontynuować, należy dotknąć prawidłowego pola. <u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!',
					'</p>',
			...
			instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Część blockNum z nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Należy użyć przycisku <b>E</b> dla elementów z kategorii <font color="#336600">leftCategory</font> oraz <font color="#0000ff">leftAttribute</font>.<br/>' +
				'Należy użyć przycisku <b>I</b> dla elementów z kategorii <font color="#336600">rightCategory</font> oraz <font color="#0000ff">rightAttribute</font>.<br/>' +
				'Każdy element należy do tylko jednej kategorii.<br/><br/>' +
				'Jeśli popełni Pan/i błąd, pojawi się czerwony znak<font color="#ff0000"><b>X</b></font>.' +
				'Aby kontynuować, należy nacisnąć prawidłowy przycisk.<br/>' + 
				'<u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!<br/><br/></p>' +
				'<p align="center">Prosimy nacisnąć <b>SPACJĘ</b>, aby kontynuować.</font></p></div>',
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'Prosimy dotknąć zielonego pola po <b>lewej</b> dla elementów należących do kategorii <font color="#336600">leftCategory</font> oraz <font color="#0000ff">leftAttribute</font>.</br>',
						'Prosimy dotknąć zielonego pola po <b>prawej</b> dla elementów należących do kategorii <font color="#336600">rightCategory</font> oraz <font color="#0000ff">rightAttribute</font>.</br>',
							'Jeśli popełni Pan/i błąd, pojawi się czerwony znak<font color="#ff0000"><b>X</b></font>. Aby kontynuować, należy dotknąć prawidłowego pola. <u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!</br>',
						'</p>',
						'<p align="center">Prosimy dotknąć zielonego pola <b>na dole</b>, aby rozpocząć.</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Część blockNum z nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Ta część jest taka sama jak poprzednia.<br/>' +
				'Należy użyć przycisku <b>E</b> dla elementów z kategorii <font color="#336600">leftCategory</font> oraz <font color="#0000ff">leftAttribute</font>.<br/>' +
				'Należy użyć przycisku <b>I</b> dla elementów z kategorii <font color="#336600">rightCategory</font> oraz <font color="#0000ff">rightAttribute</font>.<br/>' +
				'Każdy element należy do tylko jednej kategorii.<br/><br/>' +
				'<u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!<br/><br/></p>' +
			...
			instSecondCombinedTouch:[
				'<div>',
					'<p align="center"><u>Część blockNum z nBlocks</u></p>',
					'<br/>',
					'<br/>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'Prosimy dotknąć zielonego pola po <b>prawej</b> dla elementów należących do kategorii <font color="#336600">rightCategory</font> oraz <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
						'<u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!<br/>',
					'</p>',
					'<p align="center">Prosimy dotknąć zielonego pola <b>na dole</b>, aby rozpocząć.</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Część blockNum z nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'<b>Uwaga, kategorie zamieniły się miejscami!</b><br/>' +
				'Dla elementów z kategorii <font color="#336600">leftCategory</font> należy użyć przycisku <b>E</b>.<br/>' +
				'Dla elementów z kategorii <font color="#336600">rightCategory</font> należy użyć przycisku <b>I</b>.<br/><br/>' +
				'<u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!<br/><br/></p>' +
				'<p align="center">Prosimy nacisnąć <b>SPACJĘ</b>, aby kontynuować.</font></p></div>',
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Uwaga, kategorie zamieniły się miejscami!<br/>',
							'Prosimy dotknąć zielonego pola po <b>lewej</b> dla elementów należących do kategorii <font color="#336600">leftCategory</font>.<br/>',
							'Prosimy dotknąć zielonego pola po <b>prawej</b> dla elementów należących do kategorii <font color="#336600">rightCategory</font>.<br/>',
							'Elementy będą się pojawiać pojedynczo.',
							'<br/>',
							'Jeśli popełni Pan/i błąd, pojawi się czerwony znak <font color="#ff0000"><b>X</b></font>. Aby kontynuować, należy dotknąć prawidłowego pola. <u>Prosimy odpowiadać najszybciej, jak to możliwe</u> bez popełniania błędów!<br/>',
						'</p>',
						'<p align="center">Prosimy dotknąć zielonego pola <b>na dole</b>, aby rozpocząć.</p>',
